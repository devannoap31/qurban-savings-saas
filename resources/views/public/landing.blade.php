    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row items-center gap-16">
            ...
            <div class="w-full md:w-1/2">
                <div class="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-[8px] p-8 shadow-sm transform rotate-1 hover:rotate-0 transition duration-500">
...
<div class="bg-[var(--color-surface)] py-24">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <x-card class="bg-[var(--color-surface)] hover:-translate-y-2 transition-transform duration-300">
