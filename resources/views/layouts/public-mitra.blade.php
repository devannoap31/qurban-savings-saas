        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-20">
                ...
                <div class="hidden md:flex items-center gap-6 font-display">
                    <a href="{{ route('pages.tentang') }}" class="text-[var(--color-text-secondary)] hover:text-[var(--color-secondary)] font-medium text-sm transition">Tentang</a>
                    <a href="{{ route('pages.panduan') }}" class="text-[var(--color-text-secondary)] hover:text-[var(--color-secondary)] font-medium text-sm transition">Panduan</a>
                    ...
                    <a href="{{ route('mitra.register') }}" class="bg-[var(--color-secondary)] text-[var(--color-primary)] px-6 py-2.5 rounded-full text-sm font-medium hover:bg-[var(--color-accent)] transition shadow-sm">Daftar Masjid</a>
                </div>
        ...
        <div class="fixed inset-0 flex justify-end z-40">
            <div x-show="mobileMenuOpen" x-transition:enter="transition ease-in-out duration-300 transform" x-transition:enter-start="translate-x-full" x-transition:enter-end="translate-x-0" x-transition:leave="transition ease-in-out duration-300 transform" x-transition:leave-start="translate-x-0" x-transition:leave-end="translate-x-full" class="relative flex w-full max-w-xs flex-col overflow-y-auto bg-[var(--color-surface)] pb-12 shadow-xl h-full">
                ...
                <div class="space-y-6 px-4 py-6 font-display flex flex-col gap-4">
                    <a href="{{ route('pages.tentang') }}" class="text-[var(--color-text-secondary)] hover:text-[var(--color-secondary)] font-medium text-sm transition">Tentang Kami</a>
                    <a href="{{ route('pages.panduan') }}" class="text-[var(--color-text-secondary)] hover:text-[var(--color-secondary)] font-medium text-sm transition">Panduan Tabungan</a>
                    
                    <a href="{{ route('mitra.login') }}" class="text-[var(--color-text-secondary)] hover:text-[var(--color-secondary)] font-medium text-sm transition">Masuk Mitra</a>
                    <a href="{{ route('mitra.register') }}" class="w-full text-center bg-[var(--color-secondary)] text-[var(--color-primary)] px-6 py-2.5 rounded-full text-sm font-medium hover:bg-[var(--color-accent)] transition shadow-sm">Daftar Masjid</a>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-[var(--color-text-secondary)] font-body">
                        <li><a href="{{ route('pages.tentang') }}" class="hover:text-[var(--color-accent)] transition">Tentang Kami</a></li>
                        <li><a href="{{ route('pages.panduan') }}" class="hover:text-[var(--color-accent)] transition">Panduan Tabungan</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-[var(--color-text-secondary)] font-body">
                        <li><a href="{{ route('pages.bantuan') }}" class="hover:text-[var(--color-accent)] transition">Pusat Bantuan</a></li>
                        <li><a href="{{ route('pages.privasi') }}" class="hover:text-[var(--color-accent)] transition">Kebijakan Privasi</a></li>
                        <li><a href="{{ route('pages.syarat') }}" class="hover:text-[var(--color-accent)] transition">Syarat & Ketentuan</a></li>
                    </ul>
                </div>
            </div>
